...
public class DataHandler {
    ...
    private void processRequest() {
        switch (data.getRequestCode()) {
            ...
            case TransferConstants.CLIENT_DATA_WD:
                processPeerDeviceInfo();
                Intent intent = new Intent(TangyP2PPlugin.FIRST_DEVICE_CONNECTED);
                intent.putExtra(TangyP2PPlugin.KEY_FIRST_DEVICE_IP, senderIP);
    ...
    private void processChatData() {
        ...
        Intent chatReceivedIntent = new Intent(TangyP2PPlugin.ACTION_CHAT_RECEIVED);
        chatReceivedIntent.putExtra(TangyP2PPlugin.KEY_CHAT_DATA, chatObject);
